...
HashMap<String,Integer> data = new HashMap<String,Integer>();
	...
	public void login() {
		data.put("ATHARVA",2003);
		data.put("ATHARVA",1603);
...
//Question starts
	while(System.currentTimeMillis()<endtime) {
		...
		System.out.println("\n(1) Manmohan Singh"+"\t"+"(2) Jawaharlal Nehru"+"\t"+"(3) Narendra Modi"+"\t"+"(4) Lal Bahadur Shastri");
		...
		System.out.println("1) Sri Narayan Guru"+"\t"+"2) Mukund Rao Patil"+"\t"+"3) Dr. B.R.Ambedkar"+"\t"+"4)Jyotirao Phule");
		System.out.println("Enter correct option");
		ans=sc.nextInt();
		System.out.println("Answer Locked...");
		if(ans==4) {
		...
		System.out.println("1)22 March"+"\t"+"2) 10 December"+"\t"+"3) 13 November"+"\t"+"4) 27 January");
		System.out.println("Enter correct option");
		ans=sc.nextInt();
		System.out.println("Answer Locked...");
		if(ans==1) {
